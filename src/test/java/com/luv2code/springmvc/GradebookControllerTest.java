...
@SpringBootTest
@Transactional  //Because we will use JPA entity manager directly here
...
//    }
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        //objectMapper is from Jackson API, writeValueAsString will generate a JSON string fromJava object
    ...
    public void deleteStudentHttpRequestErrorPage() throws Exception {
        ...
        //Here response will as a follws as wehave Exception handlers
        //{status:..  ,messsage:...,timestamp:...   }
    }
    ...
    @Test
    public void createAValidGradeGradeHttpRequestStudentDoestNotExistEmptyResponse() throws Exception {
    ...
    @Test
    public void createANonValidGradeGradeHttpRequestGradetypeDoestNotExistEmptyResponse() throws Exception {
    ...
    @Test
    public void deleteGradeHttpRequestStudentIdDoestNotExistEmptyResourceEmptyResponse() throws Exception {


        //here 2 studentId doesnt exists
    ...
    public void deleteNonValidGradeHttpRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/grades/{id}/{gradeType}",1,"litrature"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message",is("Student or Grade was not found")));
    }
